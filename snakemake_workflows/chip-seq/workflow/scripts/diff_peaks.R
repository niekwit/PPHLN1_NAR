...
bamReads <- paste0("mapped/",csv$genotype,"_",csv$sample,"_",csv$factor,"_",csv$treatment,".dedup.bam") 
bamControls <- paste0("mapped/",csv$genotype,"_",csv$sample,"_input_",csv$treatment,".dedup.bam") 
